...
const ProductEnquiryModal = ({ isOpen, onClose, productName }) => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("PRODUCT ENQUIRY PAYLOAD:", payload);
    onClose();
  };
    ...
    >
      ...
      <div
        className="
          ...
          flex flex-col
        "
        onClick={(e) => e.stopPropagation()} // ✅ INSIDE DOES NOT CLOSE
      >
        {/* HEADER */}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <CForm className="space-y-4" onSubmit={handleSubmit}>
            ...
            <FormField label="Required Quantity *" name="quantity" value={formData.quantity} onChange={handleChange} />
            ...
            <button
              type="submit"
              className="w-full py-2.5 bg-orange-600 text-white font-semibold rounded-md"
            >
              Submit Enquiry
            </button>
          </CForm>
